...
def list_all_models():
    ...
    :return: A list of ModelInfo objects representing each saved model.
    """
...
def get_model(model_id: int):
    ...
    :param model_id: The unique identifier of the model to retrieve.
    :return: A list of ModelInfo objects matching the specified model ID.
    :raises HTTPException: If no model is found with the given ID.
    """
    models = find_model_files(model_id=None, version_id=None)
    matched_models = [
...
def download_model(model_id: int):
    ...
    :return: A ModelInfo object containing information about the downloaded model.
    """
...
def remove_model(model_id: int):
    ...
    :return: A list of ModelInfo objects representing the deleted models.
    :raises HTTPException: If no model files are found for the given ID.
    """
...
def remove_all_models():
    ...
    :return: A list of ModelInfo objects representing the deleted models.
    :raises HTTPException: If no model files are found.
    """
...
def get_model_version(model_id: int, version_id: int):
    ...
    :param version_id: The unique identifier of the model version.
    :return: A ModelInfo object representing the specified model version.
...
def download_model_version(model_id: int, version_id: int):
    ...
    :param model_id: The unique identifier of the model.
    :param version_id: The unique identifier of the model version to download.
    :return: A ModelInfo object containing information about the downloaded model version.
    """
...
def remove_model_version(model_id: int, version_id: int):
    ...
    :param model_id: The unique identifier of the model.
    :param version_id: The unique identifier of the model version to delete.
    :return: A ModelInfo object representing the deleted model version.
    :raises HTTPException: 
